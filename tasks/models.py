...
class Tasks(models.Model):
    ...
    emotion_before=models.CharField(max_length=50,blank=True, null=True) #할 일 전 서브 이모션(하나만 선택 가능하게 할 경우)
    emotion_after=models.CharField(max_length=50,blank=True, null=True) #할 일 마친 후 서브 이모션(하나만 선택 가능하게 할 경우)
